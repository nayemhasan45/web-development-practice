        ...
        createDiv.innerHTML = `
            ...
            <div class=" flex flex-row gap-3 mt-4">
                ...
                <div>
                    ...
                    <p class="font-normal text-sm py-2 text-[#17171770]">${video.authors[0].profile_name}</p>
                    ${video.authors[0].verified ? `
        <svg xmlns="http://www.w3.org/2000/svg" class="inline ml-1" width="20" height="20" viewBox="0 0 20 20" fill="none">
